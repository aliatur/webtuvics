...
export const HoroscopeChart: React.FC<HoroscopeChartProps> = ({
  ...
  return (
    <div className="space-y-6">
        ...
        <div className="flex gap-3 items-start">
          ...
          <div className="flex-1 space-y-1">
            ...
            <div className="text-xs space-y-2 leading-relaxed">
              <p>
                - Giờ sinh gốc: <strong className="text-stone-900 dark:text-white">{timezoneNormalization.originalDate} ({timezoneNormalization.originalTime})</strong> tại {timezoneNormalization.birthplace === "Miền Nam VN" ? "Miền Nam Việt Nam" : timezoneNormalization.birthplace}.
              </p>
              <p>
      ...
      <div className="relative p-2 bg-stone-100 dark:bg-neutral-900/50 rounded-2xl border-4 border-stone-800 dark:border-neutral-800 shadow-xl overflow-x-auto">
