  ...
  return (
    <div className="bg-white dark:bg-neutral-900 rounded-2xl border border-stone-250 dark:border-neutral-800 shadow-xl overflow-hidden">
      ...
      <div className="p-6 space-y-6">
        ...
        {!apiKey && (
          <div className="p-3 bg-indigo-50/50 dark:bg-indigo-950/15 rounded-lg border border-indigo-150 dark:border-indigo-900/40 flex items-start gap-2.5 text-xs text-indigo-800 dark:text-indigo-300">
            <AlertTriangle className="w-4 h-4 text-indigo-600 shrink-0 mt-0.5" />
            <p className="leading-tight">
              - <strong>Chế độ Bring-Your-Own-Key:</strong> Quý vị nên điền khóa API Gemini cá nhân ở thanh cấu hình phía trên để tránh giới hạn lượt dùng thử. Cách lấy khóa miễn phí truy cập vào <a href="https://aistudio.google.com" target="_blank" rel="noreferrer" className="underline font-bold hover:text-indigo-600">Google AI Studio</a>. Nếu không điền, ứng dụng sẽ phục vụ sử dụng thử bằng khóa máy chủ nếu có.
            </p>
          </div>
        )}
