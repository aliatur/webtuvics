...
export default function App() {
  ...
  const [modelSelection, setModelSelection] = React.useState<"gemini-3.5-flash" | "gemini-3.1-pro-preview">("gemini-3.5-flash");
        ...
        <div className="lg:col-span-4 space-y-6">
          ...
          <div className="bg-white dark:bg-neutral-900 p-6 rounded-2xl border border-stone-250 dark:border-neutral-800 shadow-lg space-y-5">
            ...
            <form onSubmit={handleCalculateClick} className="space-y-4">
              ...
              <div className="space-y-1.5">
                ...
                <input
                  type="text"
                  placeholder="Ví dụ: Lương Tuấn Minh"
                  value={profileName}
          ...
          <div className="bg-white dark:bg-neutral-900 p-6 rounded-2xl border border-stone-250 dark:border-neutral-800 shadow-md space-y-4">
              ...
              {savedProfiles.map((p) => (
                ...
                >
                  <div className="space-y-0.5 text-left">
                    ...
                    <p className="text-[10px] text-stone-400 font-medium">
                      {p.solarDate} • {p.solarTime} • {p.birthplace === "Miền Nam VN" ? "M.Nam" : p.birthplace.includes("Miền Trung") ? "M.Trung" : p.birthplace.includes("Nước ngoài") ? "N.Ngoài" : "M.Bắc"}
                    </p>
                  </div>
                  <button
            ...
            <div className="text-[10px] text-stone-400 leading-normal p-2.5 bg-stone-50 dark:bg-neutral-950 rounded-lg border border-stone-200 dark:border-neutral-800 flex items-start gap-1.5">
              ...
              <p>
                <strong>Tử Vi Đẩu Số</strong> là khoa lập pháp nghiên cứu chu kỳ tinh tú. Sự chính xác của giờ Tý biên cải theo từng tháng âm lịch chính là tinh hoa cốt tủy loại bỏ sai sót mà TuviGLOBAL đề xướng.
              </p>
            </div>
          </div>
